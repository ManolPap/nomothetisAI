...
export function extractSector(file: File, signal?: AbortSignal): Promise<ExtractSectorResponse> {
  ...
  return postFormData<ExtractSectorResponse>(buildUrl('/field9/extract-sector'), form, { signal })
}
...
export function suggestIndicators(
  ...
  return postJson<SuggestIndicatorsResponse>(buildUrl('/field9/suggest-indicators'), payload, { signal })
}
...
export function fetchIndicatorData(
  ...
  return postJson<FetchDataResponse>(buildUrl('/field9/fetch-data'), payload, { signal })
}
